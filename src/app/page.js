        ...
        <main className="bg-green-700 flex flex-col items-center justify-start gap-10 w-[600px] h-[600px] p-10 mt-10 rounded-lg ">
          ...
          <div className="flex flex-col items-start gap-3 w-full">
            ...
            <div className="flex flex-col w-full">
              ...
              <input type="text" className="bg-slate-600 text-white h-10 rounded-lg p-1 focus:outline outline-white" 
            ...
            <div className="flex flex-col gap-1 w-full">
              ...
              <input type="text" className="bg-slate-600 h-10 text-white rounded-lg p-1 focus:outline outline-white" 
            ...
            <div className="flex flex-col gap-1 w-full">      
              ...
              <input type="password" className="bg-slate-600 h-10 text-white rounded-lg p-1 focus:outline outline-white" 
